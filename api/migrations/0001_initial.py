# Generated by Django 3.1.6 on 2021-04-27 19:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', api.custom_fields.EncryptedField(max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('card_number', api.custom_fields.EncryptedField(max_length=200)),
                ('expiration', api.custom_fields.EncryptedField(max_length=200)),
                ('security_code', api.custom_fields.EncryptedField(max_length=200)),
